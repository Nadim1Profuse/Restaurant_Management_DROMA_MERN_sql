...
export default function EmpAddModel(props) {
  const [isEmpAddOpen] = useState(props.isAddModuleOpen);
  ...
  const radios = [
    {
      ...
      isDisabled: sectionDisabled.personalDetails,
    },
    {
      name: "Address/Contact Details",
      value: "addContClicked",
      isDisabled: sectionDisabled.addContDetails,
    },
    {
      name: "Professonal Details",
      value: "profClicked",
      isDisabled: sectionDisabled.professionalDetails,
    },
    {
      name: "Education Details",
      value: "educationClicked",
      isDisabled: sectionDisabled.educationDetails,
    },
    {
      name: "Reference Details",
      value: "referenceClicked",
      isDisabled: sectionDisabled.referenceDetails,
    },
  ];
  ...
  function finalFullFormDetails() {
    ...
    console.log("clicked on full form details");
    console.log(empPersonalDetails);
    ...
    Axios.post(
      "http://localhost:3001/empDetailsApi/add",
      empPersonalDetails
    ).then((res) => {
      if (res.status === 200) {
        ...
        console.log(
          "successfully Added EMployeePersonal Details with empId=" +
            lastAddedEmpId
        );
  ...
  return (
    <>
      <div style={{ display: isEmpAddOpen ? "block" : "none" }}>
        <CloseAddModel show={modalShow} onHide={() => setModalShow(false)} />
        <div
          style={{
            display: "flex",
                ...
                <EmpDetailsForm
                  submitNext={() => {
                    ...
                    setSectionDisabled((prev) => {
                      return { ...prev, addContDetails: false };
                    });
                  }}
              ...
              {radioValue === "addContClicked" ? (
                <EmpAddContForm
                  submitNext={() => {
                    ...
                    setSectionDisabled((prev) => {
                      return { ...prev, professionalDetails: false };
                    });
                  }}
              ...
              {radioValue === "profClicked" ? (
                <EmpProfDetails
                  submitNext={() => {
                    ...
                    setSectionDisabled((prev) => {
                      return { ...prev, educationDetails: false };
                    });
                  }}
              ...
              {radioValue === "educationClicked" ? (
                <EmpEducationDetails
                  submitNext={() => {
                    ...
                    setSectionDisabled((prev) => {
                      return { ...prev, referenceDetails: false };
                    });
                  }}
